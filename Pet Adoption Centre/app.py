...
@app.route("/edit-pet/<id>", methods=("GET", "POST"))
def edit_pet(id):
    pet = Pet.query.get_or_404(id)
    if request.form:
        # Update pet information based on the form submission
        ...
        return redirect(url_for("view_pet", id=id))
...
def delete_pet(id):
    ...
    if pet is None:
        # Pet not found, handle it accordingly (e.g., show an error page or redirect)
        abort(404)
